...
|Daniel_CK|其它玩家在场情况下公然盗取财物，拒不解释并退服|
|heimaoyan|恶意破坏玩家建筑|

## 玩1.19.X会不会被人恶意举报封号？

目前服务器停用消息签名功能，即所有玩家的聊天消息都不会被加上签名（服务器可能会提示不安全的消息），即使有人恶意举报，<font color=red>未经签名的消息也无法作为证据发挥作用</font>。如果希望进一步加强防护，可以为客户端下载安装[No Chat Reports](https://www.curseforge.com/minecraft/mc-mods/no-chat-reports)这个mod。该mod的主要作用为去除玩家所发送消息的签名信息，同时也禁止玩家使用聊天举报功能。

当然，就目前来看只有Java版本游戏可以通过插件等方式杜绝聊天举报，但是Mojang和微软可能不会只满足于这种程度的自我审查，未来还有诸多变数。现在最重要的是，不要随便游玩基岩版，或是在基岩版游戏中发言，以免被不怀好意的人盯上。
