...
> [!warning]
> 古语有云：“以人为镜，可以明得失。”赛博空间有赛博空间的规矩，对于违反规矩的人员，当然是挂人一时爽，一直挂人一直爽。
>
> 考虑到本服未启用白名单，任何没有本服封禁记录的正版账号都可以进入服务器，这就会不可避免地引来熊孩子，在任何时段任何地点进行随机破坏。因此**强烈建议**玩家在经济充足的情况下，进行圈地并设置相关权限，以保护自己在游戏内的财产。
...
|**<font color=red>Diving7</font>**|蓄意破坏其他玩家领地周围地理环境并拒绝恢复|
|**<font color=red>Lanse_Fox</font>**|盗窃其他玩家财产|
|**<font color=red>Your_Promise</font>**|使用矿透；使用TNT炸毁玩家建筑|
|**<font color=red>Daniel_CK</font>**|其它玩家在场情况下公然盗取财物，拒不解释并退服|
|**<font color=red>heimaoyan</font>**|恶意破坏玩家建筑|
|**<font color=red>Hello_Z</font>**|私自建造更新抑制器和跳略器，严重消耗服务器硬件资源，恶意卡服|
|**<font color=red>pigeon_games</font>**|Hello_Z同伙|
|**<font color=red>pjlwdnmd</font>**|使用矿透等作弊mod|
|**<font color=red>SeeleLin</font>**|恶意破坏玩家建筑|
|**<font color=red>lazlo5334</font>**|发消息刷屏，严重影响其他玩家游戏体验|
|**<font color=red>Aceyuhang123</font>**|恶意破坏玩家物品|
|**<font color=red>Acehangyu123</font>**|Aceyuhang123的小号|
|**<font color=red>Overmarsone</font>**|开挂|
|**<font color=red>xiaohei1314</font>**|盗取玩家游戏财产|
|**<font color=red>ILuckeistI</font>**|盗窃并破坏其他玩家游戏财产|
|**<font color=red>lezigongxianghao</font>**|主动挑衅，随意辱骂他人|
|**<font color=red>CappedVeil22207</font>**|lezigongxianghao同伙|

## 玩1.19.X会不会被人恶意举报封号？

目前服务器停用消息签名功能，即所有玩家的聊天消息都不会被加上签名（服务器可能会提示不安全的消息），即使有人恶意举报，<font color=red>未经签名的消息也无法作为证据发挥作用</font>。

如果希望进一步加强防护，可以为客户端下载安装[No Chat Reports](https://www.curseforge.com/minecraft/mc-mods/no-chat-reports)等反聊天举报mod。这些mod在客户端就能去除聊天中的签名信息，经过服务器转发之后，就更加难以作为举报证据将聊天消息与特定玩家关联起来，从而避免Mojang的审查。

当然，就目前来看只有Java版本游戏可以通过插件等方式杜绝聊天举报，但是Mojang和微软可能不会只满足于这种程度的自我审查，未来还有诸多变数。现在最重要的是，不要随便进入1.19.X的**基岩版**服务器游玩，或是在1.19.X基岩版服务器中谨慎发言，以免被不怀好意的人盯上。

## 服务器资源包怎么安装？

服务器使用了自定义的拓展物品，需要玩家安装资源包才能正常看到它们，否则就只能看见一堆马鞍和纸片。资源包可以从群文件目录`★★★服务器★★★`里下载最新日期发布的资源包，下图为示例：
...
不支持。本服务器<font color=red>仅支持Java版</font>玩家登入，并且**短期内不打算，也无法实现Java版与基岩版的互通**。
...
另一方面，一个重要的问题是，1.19版本推出聊天举报功能以后，<font color=red>如果Java版和基岩版进行互通，玩家的游戏安全很可能无法得到保证</font>——基岩版目前还没有阻止消息签名的手段，我们不能随意将玩家暴露在这种不可预测的风险之下。
...
我们无法提供任何与此相关的技术支持，**请正版玩家务必使用官方提供的正式渠道**找回账号密码，<font color=red>切勿轻信和使用任何由未知第三方提供的账号密码找回服务</font>！